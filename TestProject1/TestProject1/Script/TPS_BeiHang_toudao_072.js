...
function editMachineManagementThenCancel(loginUserName, loginPassword, newConfigName, editMachineTab, editMachineProperty, editMachinePropertyValue) {    
    ...
    physicalparameterutils.editMachine(indel, false, newConfigName, editMachineTab, editMachineProperty, editMachinePropertyValue);
    ...
    aqObject.CompareProperty(result, cmpNotEqual, editMachinePropertyValue, true, 3);
