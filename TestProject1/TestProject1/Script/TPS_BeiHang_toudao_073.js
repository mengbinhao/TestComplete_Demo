...
function editMachineManagement(loginUserName, loginPassword, newConfigName, editMachineProperty, editMachinePropertyValue) {    
    ...
    physicalparameterutils.editMachine(indel, true, newConfigName, tabIndex, editMachineProperty, editMachinePropertyValue);
