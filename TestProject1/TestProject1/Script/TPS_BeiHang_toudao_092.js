...
function importMachineManagement(loginUserName, loginPassword, newConfigName) {    
    ...
    if (!strictEqual(ret, -1)) {
        ...
        //re-search import item
        ret =  finditeminlist.isItemInListReturnIndex(newConfigName, machineConfigNameColumn, machineList);
